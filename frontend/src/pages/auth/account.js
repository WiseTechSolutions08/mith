      ...
      return (
         <Layout noHeaderTop sideBar sticky headerStyle={1} footerStyle={1}>
            ...
            <div className="login-form mithra-flex-col">
               ...
               <div className="mt-user-bottom"> <a href="https://demo.bravisthemes.com/wellco/my-account/lost-password/">Forgot your password?</a></div>
               </div>
            </div>
         </Layout>
      );
